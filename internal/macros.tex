...
\newcommand*{\locationurl}[1]{\def\locationurl{#1}}
...
\newcommand{\cvsection}[1]{%
	\parindent0pt
	\bigskip\textcolor{themecolour}{\huge{#1}}
	\vspace{-5pt}\\
    \themerule\vspace{4pt}\par
}

\newcommand{\cvsubsection}[1]{%
	\parindent0pt
    \bigskip{\hspace{.75em}\textbf{#1}}
	\vspace{-7pt}\\\par
}
...
\newcommand{\datedfaitem}[4]{%
    \textbf{#1}\hfill\faIcon[regular]{calendar-alt}\,\textsl{#4}\par
    #2 \textsl{#3}\vspace{2mm}\par
}

% Use as \faitem{faIcon}{leftmargin}{details}
\newcommand{\faitem}[3]{%
	\begin{itemize}[
		align=left,
		leftmargin=#2,
...
%------------------------------------------------------------------------------
% Define \vbar as a coloured vertical bar
\newcommand{\vbar}{\textcolor{themecolour}{\;$\vert$}\;}
%------------------------------------------------------------------------------
