...
\newcommand*{\makecard}{%
	\hspace*{\fill}
	\siteentry \hfill \phoneentry \hfill \locationentry
	\hspace*{\fill} \vspace{3pt}\\
	\hspace*{\fill}
	\emailentry \hfill \stackoverflowentry \hfill \linkedinentry
	\hspace*{\fill} \par
}
%------------------------------------------------------------------------------
...
\newcommand{\datedfaitem}[4]{%
    \textbf{#1}\par
    #2 \textsl{#3} \hfill \faIcon[regular]{calendar} \textsl{#4}\vspace{2mm}\par
}
