...
\cvsection{Computing}
\comentry{\faIcon{python}}{Python expert; considerable experience using numpy and pandas to perform computationally demanding jobs. Confident using matplotlib to create custom data visualisations}
...
\comentry{\faIcon{git}}{Used git and github to manage multiple projects and collaborate with other researchers}
...
\comentry{\faIcon{stack-overflow}}{Regular contributor on stack overflow; answering questions on a broad range of python and linux based topics}
